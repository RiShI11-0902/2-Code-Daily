...
const UserProfile = ({ setViewState }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
            <div className="relative w-full max-w-2xl rounded-2xl shadow-lg bg-gradient-to-r from-[#070F2B] to-[#1B1A55] text-white montserrat-heading p-6 max-h-[90vh] overflow-y-auto">
