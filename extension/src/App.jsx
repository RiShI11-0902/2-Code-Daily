    ...
    >
      ...
      <footer className="flex flex-col gap-4">
        ...
        <div id="btns" className="flex flex-col sm:flex-row gap-3">
          <button
            onClick={() => handleSubmit(email, setIsSaved)}
            disabled={!email.trim()}
            className={`bg-blue-600  transition text-white p-3 rounded-lg text-sm w-full sm:w-1/2  ${!email.trim() ? "opacity-50 cursor-none" : "hover:bg-blue-700 cursor-pointer"}`}
          >
